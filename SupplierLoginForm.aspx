<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierLoginForm.aspx.cs" Inherits="SPCsystem.SupplierLoginForm" %>
...
<body>
    ...
    <br />  <br />  
     ...
     <div class="all">
      <div class="container">
      <center><div class="title">Supplier Login</div></center>
          ...
          <div class="input-box">
              ...
              <tr>
               ...
               <table>
                   <tr>
                       <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href ="SupplierRegisterForm.aspx">Register</a></td>
                   </tr>
               </table>
